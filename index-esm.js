...
let Parser$1 = class Parser {
    ...
    reportParseError(code, index = 0) {
        ...
        const error = AST$3.ParseError.fromCode(code, index);
...
let Tokenizer$1 = class Tokenizer {
    ...
    reportParseError(code) {
        const error = AST$2.ParseError.fromCode(code, this.offset);
        this.errors.push(error);
    }
...
dist.reduceExpression = css_calc_1.reduceExpression;
...
dist.parse = parse$1;
function stringify$1(node, options) {
...
Object.defineProperty(indexCjs, "__esModule", { value: true });
...
var AST_1 = indexCjs.AST = AST;
var Parser_1 = indexCjs.Parser = Parser;
var Tokenizer_1 = indexCjs.Tokenizer = Tokenizer;
var Stringifier_1 = indexCjs.Stringifier = Stringifier;
var getResolvedType_1 = indexCjs.getResolvedType = getResolvedType;
var reduceExpression_1 = indexCjs.reduceExpression = reduceExpression;
var mathExpr_1 = indexCjs.mathExpr = mathExpr;
var parse_1 = indexCjs.parse = parse;
var stringify_1 = indexCjs.stringify = stringify;
var _default = indexCjs.default = def;

export { AST_1 as AST, Parser_1 as Parser, Stringifier_1 as Stringifier, Tokenizer_1 as Tokenizer, _default as default, getResolvedType_1 as getResolvedType, mathExpr_1 as mathExpr, parse_1 as parse, reduceExpression_1 as reduceExpression, stringify_1 as stringify };
